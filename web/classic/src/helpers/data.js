...
import { normalizeDisplayLogo, normalizeDisplaySystemName } from './utils';

export function setStatusData(data) {
  localStorage.setItem('status', JSON.stringify(data));
  localStorage.setItem(
    'system_name',
    normalizeDisplaySystemName(data.system_name),
  );
  localStorage.setItem('logo', normalizeDisplayLogo(data.logo));
