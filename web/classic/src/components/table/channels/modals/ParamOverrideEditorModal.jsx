  ...
  return (
    <>
      <Modal
        ...
        cancelText={t('取消')}
      >
        <Space vertical align='start' spacing={14} className='w-full'>
          <Card
            className='na-table-modal-card'
            bodyStyle={{
          ...
          {editMode === 'visual' ? (
            <div className='na-table-modal-section'>
              {visualMode === 'legacy' ? (
                <Card
                  className='na-table-modal-card'
                  bodyStyle={{
                    padding: 'var(--na-space-3-5)',
                  }}
                >
                ...
                <div>
                  ...
                  <Row gutter={12}>
                    <Col xs={24} md={8}>
                      <Card
                        className='na-table-modal-card h-full'
                        bodyStyle={{
                          padding: 'var(--na-space-3)',
                          display: 'flex',
                          flexDirection: 'column',
                          gap: 'var(--na-space-2-5)',
                          minHeight: '32.5rem',
                        }}
                      >
                        ...
                        <div className='na-table-modal-scroll'>
                          {filteredOperations.length === 0 ? (
                            <Text type='tertiary' size='small'>
                              {t('没有匹配的规则')}
                            </Text>
                          ) : (
                            <div className='na-table-inline-form'>
                              {filteredOperations.map((operation) => {
                                ...
                                return (
                                  <div
                                    ...
                                    className='na-table-operation-card'
                                    style={{
                                      background: isActive
                                      ...
                                      boxShadow: isDropTarget
                                        ? dragOverPosition === 'after'
                                          ...
                                          : 'inset 0 calc(var(--na-space-px) * 3) 0 var(--semi-color-primary)'
                                        : 'none',
                                    }}
                                  >
                                    ...
                                    <Space
                                      spacing={6}
                                      className='na-table-inline-spacer'
                                    >
                                      <Tag
                                        size='small'
                    ...
                    <Col xs={24} md={16}>
                      {selectedOperation ? (
                        (() => {
                          ...
                          return (
                            <Card
                              className='!rounded-semi-border-radius-large !border-0'
                              bodyStyle={{
                                padding: 14,
                            ...
                            >
                              ...
                              {meta.value ? (
                                mode === 'return_error' && returnErrorDraft ? (
                                  <div className='na-table-rule-panel'>
                                  ...
                                  <div className='na-table-rule-panel'>
                                    ...
                                    {pruneObjectsDraft.simpleMode ? (
                                      ...
                                      <>
                                        ...
                                        <div className='na-table-rule-panel-inner'>
                                          <div className='flex items-center justify-between mb-2'>
                                          ...
                                          {(pruneObjectsDraft.rules || [])
                                            ...
                                            <div className='flex flex-col gap-2'>
                                              {(
                                                ...
                                                <div
                                                  key={rule.id}
                                                  className='na-table-rule-condition'
                                                >
                                                  <div className='flex items-center justify-between mb-2'>
                                                    <Tag size='small'>
                                                      {`R${ruleIndex + 1}`}
                      ...
                      {visualValidationError ? (
                        <Card
                          className='!rounded-semi-border-radius-large !border-0 mt-3'
                          bodyStyle={{
                            padding: 12,
                            background: 'var(--semi-color-fill-0)',
                          }}
      ...
      >
        <Space vertical align='start' spacing={12} className='w-full'>
          <Text type='tertiary' size='small'>
      ...
      >
        <Space vertical spacing={12} className='w-full'>
          <div className='flex items-start justify-between gap-3'>
            <div>
              <Text
                strong
                style={{
                  fontSize: 22,
                  lineHeight: 'var(--na-leading-heading)',
                }}
              >
                {t('字段速查')}
              </Text>
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          ...
                          <Text
                            ...
                            style={{
                              ...
                              border:
                                'var(--na-space-px) solid var(--semi-color-border)',
                              borderRadius: 8,
                              padding: 'var(--na-space-1) var(--na-space-2)',
                              width: 'fit-content',
                            }}
                          >
                            {field.key}
                          ...
                          <Text
                            ...
                            size='small'
                            className='block mt-1'
                            style={{ lineHeight: 'var(--na-leading-compact)' }}
                          >
                            {field.tip}
                          </Text>
                        </div>
