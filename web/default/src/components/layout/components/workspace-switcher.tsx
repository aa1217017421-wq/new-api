  ...
  const workspaceButtonContent = (
    <>
      {activeWorkspace.id === WORKSPACE_IDS.SYSTEM_SETTINGS ? (
        ...
        <div className='flex aspect-square size-8 items-center justify-center overflow-hidden rounded-md bg-card ring-1 ring-sidebar-border'>
          <img
            src={logo}
            alt={t('Logo')}
          ...
          <DropdownMenu>
            ...
            >
              ...
              {availableWorkspaces.map((workspace, index) => (
                ...
                >
                  {index === 0 ? (
                    <div className='flex size-6 items-center justify-center overflow-hidden rounded-md border bg-card'>
                      <img
                        src={logo}
                        alt='Logo'
