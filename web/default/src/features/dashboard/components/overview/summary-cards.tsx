...
export function SummaryCards() {
  ...
  return (
    <div className='overflow-hidden rounded-md border bg-card shadow-[0_8px_30px_-24px_rgba(20,20,19,0.35)]'>
      <StaggerContainer className='divide-border/60 grid grid-cols-1 divide-y sm:grid-cols-3 sm:divide-x sm:divide-y-0'>
        {items.map((it) => (
