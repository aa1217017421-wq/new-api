...
> = {
  ...
  amber: {
    ...
    activeBorder: 'border-amber-600 dark:border-amber-300',
    badge:
      'bg-amber-500/10 text-amber-700 dark:bg-amber-300/10 dark:text-amber-300',
  },
  blue: {
    activeText: 'text-[color:var(--chart-2)]',
    activeBorder: 'border-[color:var(--chart-2)]',
    badge: 'bg-muted text-[color:var(--chart-2)]',
  },
  violet: {
    activeText: 'text-foreground',
    activeBorder: 'border-foreground/70',
    ...
    <div className='mx-auto mt-16 w-full max-w-2xl'>
      <div
        className={cn(
          ...
          'border-border/70 bg-card/95 shadow-[0_18px_50px_-34px_rgba(20,20,19,0.55)]',
          'dark:bg-card dark:shadow-[0_20px_60px_-32px_rgba(0,0,0,0.7)]'
        )}
      >
        {/* Tab strip */}
        <div
...
function Flag(props: { children: ReactNode }) {
  return (
    <span className='text-[color:var(--chart-2)]'>{props.children}</span>
  )
}
